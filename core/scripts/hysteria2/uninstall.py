...
def uninstall_hysteria():
    ...
    print("\nStep 4: Removing related components (WARP)...")
    ...
    print("\nStep 8: Removing 'hys2' alias from .bashrc...")
