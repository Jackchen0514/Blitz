...
class EditUserInputBody(BaseModel):
    ...
    new_expiration_days: Optional[int] = Field(None, description="The new expiration in days (legacy field name).")
    expiration_days: Optional[int] = Field(None, description="The new expiration in days.")
