...
async def edit_user_api(username: str, body: EditUserInputBody):
    ...
    try:
        ...
        cli_api.traffic_status(display_output=False)
        effective_expiration_days = body.expiration_days if body.expiration_days is not None else body.new_expiration_days
        cli_api.edit_user(username, body.new_username, body.new_password, body.new_traffic_limit, effective_expiration_days,
